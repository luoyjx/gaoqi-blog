...
(function () {
  ...
  function M (a) {
    ...
    var e = /(?:^|\s)nocode(?:\s|$)/; var h = []; var y = 0; var t = []; var s = 0; var l
  ...
  function x (a, m) {
    function e (a) {
      for (var l = a.d, p = [l, 'pln'], d = 0, g = a.a.match(y) || [], r = {}, n = 0, z = g.length; n < z; ++n) {
        var f = g[n]; var b = r[f]; var o = void 0; var c
        if (typeof b ===
          'string')c = !1; else {
          var i = h[f.charAt(0)]
        ...
        if (c) {
          c = o[1]
          var j = f.indexOf(c); var k = j + c.length
  ...
  function D (a, m) {
    function e (a) {
      switch (a.nodeType) {
        ...
        case 4:
          if (p) {
            var b = a.nodeValue; var d = b.match(t)
            if (d) {
    ...
    function h (a) {
      function b (a, d) {
        var e = d ? a.cloneNode(!1) : a; var f = a.parentNode
        if (f) {
          var f = b(f, 1); var g = a.nextSibling
          f.appendChild(e)
  ...
  function E (a) {
    var m =
      a.g
    try {
      var e = M(a.h); var h = e.a
      a.a = h
      a.c = e.c
      a.d = 0
      C(m, h)(a)
      var k = /\bMSIE\b/.test(navigator.userAgent); var m = /\n/g; var t = a.a; var s = t.length; var e = 0; var l = a.c; var p = l.length; var h = 0; var d = a.e; var g = d.length; var a = 0
      d[g] = s
      var r, n
      ...
      for (d.length = r; h < p;) {
        var o = l[h + 2] || s; var c = d[a + 2] || s; var b = Math.min(o, c); var i = l[h + 1]; var j
        if (i.nodeType !== 1 && (j = t.substring(e, b))) {
          k && (j = j.replace(m, '\r'))
          i.nodeValue =
            j
          var u = i.ownerDocument; var v = u.createElement('SPAN')
          v.className = d[a + 1]
          var x = i.parentNode
          x.replaceChild(v, i)
          v.appendChild(i)
  ...
  var v = ['break,continue,do,else,for,if,return,while']; var w = [
  ...
  window.prettyPrint = function (a) {
    function m () {
      for (var e = window.PR_SHOULD_USE_CONTINUATION ? l.now() + 250 : Infinity; p < h.length && l.now() < e; p++) {
        var n = h[p]; var k = n.className
        if (k.indexOf('prettyprint') >= 0) {
          var k = k.match(g); var f; var b
          if (b = !k) {
            b = n
    ...
    var p = 0; var d; var g = /\blang(?:uage)?-([\w.]+)(?!\S)/
    m()
  }
  window.PR = {
    createSimpleLexer: x,
