  ...
  var define, module, exports; return (function e (t, n, r) { function s (o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require === "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n || e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require === "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    ...
    9: [function (require, module, exports) {
      ...
      module.exports = function parseLinkLabel (state, start, disableNested) {
        var level; var found; var marker; var prevPos
        var labelEnd = -1
 ...
 **/
    ...
    }, { "./common/utils": 5, "./helpers": 6, "./parser_block": 12, "./parser_core": 13, "./parser_inline": 14, "./presets/commonmark": 15, "./presets/default": 16, "./presets/zero": 17, "./renderer": 18 }],
 ...
 **/
    ...
    }, { "./ruler": 19, "./rules_block/blockquote": 20, "./rules_block/code": 21, "./rules_block/fence": 22, "./rules_block/heading": 23, "./rules_block/hr": 24, "./rules_block/html_block": 25, "./rules_block/lheading": 26, "./rules_block/list": 27, "./rules_block/paragraph": 28, "./rules_block/reference": 29, "./rules_block/state_block": 30, "./rules_block/table": 31 }],
 ...
 **/
      ...
      module.exports = Core
    }, { "./ruler": 19, "./rules_core/block": 32, "./rules_core/inline": 33, "./rules_core/linkify": 34, "./rules_core/normalize": 35, "./rules_core/replacements": 36, "./rules_core/smartquotes": 37, "./rules_core/state_core": 38 }],
 ...
 **/
   ...
   **/
      ...
      ParserInline.prototype.skipToken = function (state) {
        var i; var cached_pos; var pos = state.pos
        var rules = this.ruler.getRules('')
        var len = rules.length
        var maxNesting = state.md.options.maxNesting
 ...
 **/
    ...
    20: [function (require, module, exports) {
      ...
      module.exports = function blockquote (state, startLine, endLine, silent) {
        var nextLine; var lastLineEmpty; var oldTShift; var oldBMarks; var oldIndent; var oldParentType; var lines
        var terminatorRules
        var i; var l; var terminate
    ...
    22: [function (require, module, exports) {
      ...
      module.exports = function fence (state, startLine, endLine, silent) {
        var marker; var len; var params; var nextLine; var mem
    ...
    25: [function (require, module, exports) {
      ...
      module.exports = function html_block (state, startLine, endLine, silent) {
        var ch; var match; var nextLine
        var pos = state.bMarks[startLine]
        var max = state.eMarks[startLine]
        var shift = state.tShift[startLine]
    ...
    28: [function (require, module, exports) {
      ...
      module.exports = function paragraph (state, startLine/*, endLine */) {
        var endLine; var content; var terminate; var i; var l
    ...
    }, { "../helpers/normalize_reference": 7, "../helpers/parse_link_destination": 8, "../helpers/parse_link_title": 10 }],
    30: [function (require, module, exports) {
      ...
      StateBlock.prototype.getLines = function getLines (begin, end, indent, keepLastLF) {
        var i; var first; var last; var queue; var shift
        var line = begin
    ...
    33: [function (require, module, exports) {
      ...
      module.exports = function inline (state) {
        var tokens = state.tokens; var tok; var i; var l
    ...
    34: [function (require, module, exports) {
      ...
      module.exports = function linkify (state) {
        var i; var j; var l; var tokens; var token; var text; var nodes; var ln; var pos; var level; var htmlLinkLevel
        var blockTokens = state.tokens
        var linkifier = null; var links; var autolinker
    ...
    39: [function (require, module, exports) {
      ...
      module.exports = function autolink (state, silent) {
        var tail; var linkMatch; var emailMatch; var url; var fullUrl; var pos = state.pos
    ...
    40: [function (require, module, exports) {
      ...
      module.exports = function backtick (state, silent) {
        var start; var max; var marker; var matchStart; var matchEnd
        var pos = state.pos
    ...
    41: [function (require, module, exports) {
      ...
      function scanDelims (state, start) {
        var pos = start; var lastChar; var nextChar; var count
        var isLastWhiteSpace; var isLastPunctChar
        var isNextWhiteSpace; var isNextPunctChar
        var can_open = true
        var can_close = true
        var max = state.posMax
    ...
    42: [function (require, module, exports) {
      ...
      module.exports = function entity (state, silent) {
        var ch; var code; var match; var pos = state.pos; var max = state.posMax
    ...
    43: [function (require, module, exports) {
      ...
      module.exports = function escape (state, silent) {
        var ch; var pos = state.pos; var max = state.posMax
    ...
    44: [function (require, module, exports) {
      ...
      module.exports = function html_inline (state, silent) {
        var ch; var match; var max; var content; var pos = state.pos
    ...
    }, { "../helpers/normalize_reference": 7, "../helpers/parse_link_destination": 8, "../helpers/parse_link_label": 9, "../helpers/parse_link_title": 10 }],
    ...
    47: [function (require, module, exports) {
      ...
      module.exports = function newline (state, silent) {
        var pmax; var max; var pos = state.pos
   ...
   */
     ...
     */
          matcherRegex: (function () {
            ...
            var wwwRegex = /(?:www\.)/ // starting with 'www.'
            var domainNameRegex = /[A-Za-z0-9\.\-]*[A-Za-z0-9\-]/ // anything looking at all like a domain, non-unicode domains, not ending in a period
     ...
     */
          link: function (textOrHtml) {
            ...
            var htmlCharacterEntitiesRegex = this.htmlCharacterEntitiesRegex
            var anchorTagStackCount = 0 // used to only process text around anchor tags, and any inner text/html they may have
            var resultHtml = []
              ...
              processTextNode: function (text) {
                if (anchorTagStackCount === 0) {
                  ...
                  for (var i = 0, len = unescapedText.length; i < len; i++) {
                    ...
                    var processedTextNode = me.processTextNode(textToProcess)
     ...
     */
          processCandidateMatch: function (
            ...
            var match // Will be an Autolinker.match.Match object

            var prefixStr = "" // A string to use to prefix the anchor tag that is created. This is needed for the Twitter handle match
            var suffixStr = "" // A string to suffix the anchor tag that is created. This is used if there is a trailing parenthesis that should not be auto-linked.
     ...
     */
          matchHasUnbalancedClosingParen: function (matchStr) {
            ...
            if (lastChar === ')') {
              ...
              var closeParensMatch = matchStr.match(/\)/g)
              var numOpenParens = (openParensMatch && openParensMatch.length) || 0
              var numCloseParens = (closeParensMatch && closeParensMatch.length) || 0
     ...
     */
          createMatchReturnVal: function (match, matchStr) {
            ...
            if (typeof replaceFnResult === 'string') {
              ...
              var anchorTag = tagBuilder.build(match) // returns an Autolinker.HtmlTag instance
   ...
   */
     ...
     */
          htmlRegex: (function () {
            ...
            var attrNameRegex = /[^\s\0"'>\/=\x01-\x1F\x7F]+/ // the unicode range accounts for excluding control chars, and the delete char
            var attrValueRegex = /(?:".*?"|'.*?'|[^'"=<>`\s]+)/ // double quoted, single quoted, or unquoted attribute values
            var nameEqualsValueRegex = attrNameRegex.source + '(?:\\s*=\\s*' + attrValueRegex.source + ')?' // optional '=[value]'
     ...
     */
          parse: function (html, options) {
            ...
            var processTextNodeVisitor = options.processTextNode || function () {}
            ...
            while ((currentResult = htmlRegex.exec(html)) !== null) {
              ...
              var tagName = currentResult[1] || currentResult[3] // The <!DOCTYPE> tag (ex: "!DOCTYPE"), or another tag (ex: "a")
              var isClosingTag = !!currentResult[2]
              var inBetweenTagsText = html.substring(lastIndex, currentResult.index)
   ...
   */
     ...
     */
          addClass: function (cssClass) {
            ...
            var whitespaceRegex = this.whitespaceRegex
            var indexOf = Autolinker.Util.indexOf // to support IE8 and below
            var classes = (!classAttr) ? [] : classAttr.split(whitespaceRegex)
            var newClasses = cssClass.split(whitespaceRegex)
            var newClass
     ...
     */
          removeClass: function (cssClass) {
            ...
            var indexOf = Autolinker.Util.indexOf // to support IE8 and below
            var classes = (!classAttr) ? [] : classAttr.split(whitespaceRegex)
            var removeClasses = cssClass.split(whitespaceRegex)
            var removeClass
