...
describe('test/controller/index.test.js', function() {
  ...
  it('should /sitemap.xml 200', function(done) {
    request.get('/sitemap.xml').expect(200, function(err, res) {
  ...
  it('should /tools 200', function(done) {
    request.get('/tools').expect(200, function(err, res) {
  ...
  it('should /frontEndNavigation 200', function(done) {
    request.get('/frontEndNavigation').expect(200, function(err, res) {
  ...
  it('should /api 200', function(done) {
    request.get('/api').expect(200, function(err, res) {
